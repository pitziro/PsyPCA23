// constantes para datos de contactos
export const CONST_EMAIL_CONTACTO = 'contacto@centroperspectivas.com'
export const CONST_PHONE_NUMBER = '+51 965 723 390'
export const CONST_ADDRESS = 'Jirón Las Estrellas 317 - Santiago de Surco'
