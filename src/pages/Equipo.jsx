	...
	const equipo = [
		{
			...
			desc: 'Licenciado de la Universidad Peruana de Ciencias Aplicadas (UPC) en el 2018.  Máster en Psicología Clínica y de la Salud por la universidad CEU San Pablo - España. Posgrado en Psicología Cognitivo Conductual y TREC en la Universidad Continental. Posgrado en Terapia de Pareja y Familia por el Institute of Medicine and Psychology y la Universidad de Piura. Ponente y tallerista de habilidades socioemocionales en niños, adolescentes y adultos; como también con cargos administrativos y gerenciales. Experiencia clínica durante más de 5 años en práctica privada y en instituciones públicas y privadas a nivel nacional. Fundador de “Perspectivas - Centro de Abordaje Psicológico”; centro dedicado a la prevención, promoción e intervención de la salud mental e integral.',
		},
		{
			id: 4,
			nombre: 'Stephany Sarmiento',
			ruta: '/img/team/20_equipo_tepy.webp',
			desc: 'Licenciada por la Universidad Peruana de Ciencias Aplicadas (UPC). Cuenta con un Máster en Psicologia Clinica y de la Salud por la universidad CEU San Pablo- España. Psicoterapeuta especializada en Terapia Cognitivo Conductual. Se ha desenvuelto en ambientes clínicos y hospitalarios, realizando acompañamiento a niños y adolescentes dentro de una clínica privada bajo el programa Emergencia Pedriátrica. Experiencia clínica en consultorio privado por más de 5 años, en los que se ha desenvuelto trabajando con niños, adolescentes, adultos y parejas.',
		},
		{
			id: 3,
			nombre: 'Kiara Díaz',
